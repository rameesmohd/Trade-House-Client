...
const Sidebar = () => {
  ...
  return (
<div>
<div class="flex items-center h-screen fixed ">
	{/* component */}
	<div class=" flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900  md:hidden">
			<div class="flex flex-col items-center mt-3 border-t border-gray-700">
			<Link class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
			...
			<Link class="flex items-center justify-center w-12 h-12 mt-2 text-gray-200 bg-gray-700 rounded" href="#">
				<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		...
		<div class="flex flex-col items-center mt-2 border-t border-gray-700">
			...
			<Link class="relative flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
				<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		...
		<Link class="flex items-center justify-center w-16 h-16 mt-auto bg-gray-800 hover:bg-gray-700 hover:text-gray-300" href="#">
			<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
	...
	<div className=" flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900  hidden md:block">
		<div className="w-full px-2">
			<div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
				...
				<Link className={`flex items-center w-full h-12 px-3 mt-2 rounded ${location.pathname === '/admin/tutor-request' ? 'bg-gray-700 text-gray-300' : ''} 
					hover:bg-gray-700 hover:text-gray-300`}>
					<svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
					</svg>
					<span className="ml-2 text-sm font-medium">Instructors</span>
				</Link>
			...
			<div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
				<Link className={`flex items-center w-full h-12 px-3 mt-2 rounded ${location.pathname === '/admin/tutors' ? 'bg-gray-700 text-gray-300' : ''} 
					hover:bg-gray-700 hover:text-gray-300`} >
					<svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
					</svg>
					<span className="ml-2 text-sm font-medium">Tutorship</span>
				</Link>
