...
const CryptoPaymentModal = ({setShowModel}) => {
    
  return (
    <>
          <div id="crypto-modal" tabindex="-1" aria-hidden="true" className="fixed top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto flex justify-center items-center h-[calc(100%-1rem)] max-h-full">
        <div className="relative w-full max-w-md max-h-full">

        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div className="px-6 py-4 border-b flex justify-between rounded-t dark:border-gray-600">
                <h3 className="text-base font-semibold text-gray-900 lg:text-xl dark:text-white">
                    Connect wallet
                </h3>
                <h5 onClick={()=>setShowModel(false)} className='text-white text-lg cursor-default'>X</h5>
            </div>
