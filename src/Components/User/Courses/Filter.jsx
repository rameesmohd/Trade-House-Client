        ...
        <main className="mx-auto max-w-full px-4 sm:px-6 lg:px-8 bg-slate-50">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-16">
            <div className='w-full'>
                <h1 className="text-4xl font-poppins font-bold tracking-tight text-gray-900 text-center ">All Courses</h1>
                <div className='text-center font-poppins'>Expand your knowledge with our beginner to advanced courses on financial markets.</div>
            </div>
