...
const Home = () => {
  ...
  return (
    <>   
    <div className='w-full h-[350px] bg-slate-100 flex justify-center '>
      <div className=' px-4 sm:px-8 lg:grid lg:grid-cols-12 overflow-hidden '>
          <div className='flex fy-end lg:col-span-6 mr-6 lg:ml-56' >
